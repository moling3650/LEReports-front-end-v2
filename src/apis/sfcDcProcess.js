...
function fetchDataBySFC (sfc) {
  ...
  UNION ALL
  SELECT NULL AS SHOP_ORDER,NULL AS STATION_CODE,CELL_ID AS SFC_NO,NULL AS RESOURCE_NO,'FORMATION' AS PROCESS_NO,EndTime AS DC_TIME,RESULT,NULL AS CREATE_USER FROM BATTERY_FORMATION
  UNION ALL
